...
public class View extends javax.swing.JFrame implements MessageHandler {
            ...
            for (int i = 0; i < 8; i++) {
                for (int j = 0; j < 8; j++) {
                    if (gameboard[i][j] == "0"){
                        ...
                        visibleGameBoard[i][j].setBackground(new Color(153, 153, 0));
                    }
                    else if (gameboard[i][j] == "_"){
                        visibleGameBoard[i][j].setBackground(Color.blue);
                    }
                }
            }
        }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jButton56.setBackground(new java.awt.Color(153, 153, 0));
